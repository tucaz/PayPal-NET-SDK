...
namespace RestApiSample
{
    public partial class OrderSample : System.Web.UI.Page
    {
        ...
        /// Refunds an order.
        /// 
        /// NOTE: Refund only works after the order amount is captured. You cannot
        ///       do a refund if the order is not captured.
        /// 
        /// More Information:
        /// https://developer.paypal.com/webapps/developer/docs/api/#refund-an-order
        /// </summary>
        private void RefundOrder()
        {
            var refund = new Refund();
            refund.amount = this.amount;
            this.order.Refund(this.apiContext, refund);
        }
    }
}
