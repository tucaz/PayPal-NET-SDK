...
{
    public partial class InvoiceTemplateUpdate : BaseSamplePage
    {
        protected override void RunSample()
        {
            ...
            // ^ Ignore workflow code segment
            #region Track Workflow
            this.flow.AddNewRequest("Update the Template.", createdTemplate);
            #endregion

            // Create the invoice
            var updatedTemplate = createdTemplate.Update(apiContext);

            // ^ Ignore workflow code segment
            #region Track Workflow
            this.flow.RecordResponse(updatedTemplate);
            #endregion
